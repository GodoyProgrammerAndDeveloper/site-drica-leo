  ...
  const galeria = [
    {
      ...
      antes: 'https://images.unsplash.com/photo-1560448204-603b3fc33ddc?w=600',
      depois: 'https://images.unsplash.com/photo-1560448204-603b3fc33ddc?w=600',
      descricao: 'Transformação de sala de estar',
      local: 'Recife - PE'
    }
  ];
    ...
    <div className="servico-page">
      <div className="servico-header" style={{ marginBottom: '2rem' }}>
        <h1 style={{ fontSize: '2.5rem', color: '#1f618d', marginBottom: '1rem' }}>
          <i className="fas fa-couch" style={{ marginRight: '1rem' }}></i>
          Salas
        </h1>
        <p style={{ fontSize: '1.2rem', color: '#2874a6', borderLeft: '4px solid #85c1e9', paddingLeft: '1rem' }}>
          Organização profissional para sua sala
        </p>
      </div>
