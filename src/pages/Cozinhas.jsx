...
function Cozinhas() {
  ...
  const galeria = [
    {
      id: 1,
      titulo: 'Organização com Colmeias - Frente',
      antes: '/images/Organização comeias frente Antes.jpeg',
      depois: '/images/Organização comeias frente Depois.jpeg',
      descricao: 'Transformação da frente da cozinha com colmeias',
      local: 'Recife - PE'
    },
    {
      id: 2,
      titulo: 'Organização com Colmeias - Lado Esquerdo',
      antes: '/images/Organização comeias Lado Esquerdo Antes.jpeg',
      depois: '/images/Organização comeias Lado Esquerdo Depois.jpeg',
      descricao: 'Organização do lado esquerdo da cozinha',
      local: 'Olinda - PE'
    },
    {
      id: 3,
      ...
      descricao: 'Organização de louças e utensílios',
      local: 'Jaboatão - PE'
    },
    {
      id: 4,
      titulo: 'Colmeias Organizadoras',
      antes: '/images/Comeias_01.jpeg',
      depois: '/images/Organização com colmeias.jpeg',
      descricao: 'Detalhe da organização com colmeias',
      local: 'Recife - PE'
    }
  ];
    ...
    <div className="servico-page">
      <div className="servico-header" style={{ marginBottom: '2rem' }}>
        <h1 style={{ fontSize: '2.5rem', color: '#1f618d', marginBottom: '1rem' }}>
          <i className="fas fa-kitchen-set" style={{ marginRight: '1rem' }}></i>
          Cozinhas Organizadas
        </h1>
        <p style={{ fontSize: '1.2rem', color: '#2874a6', borderLeft: '4px solid #85c1e9', paddingLeft: '1rem' }}>
          Transformamos sua cozinha em um espaço funcional
        </p>
      </div>
