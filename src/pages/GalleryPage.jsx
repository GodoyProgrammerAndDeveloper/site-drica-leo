...
const GalleryPage = () => {
  ...
  const mediaItems = [
    // VÍDEOS (com fallback se thumbnail não existir)
    {
      id: 1,
      type: 'video',
      thumbnail: '/images/thumbnail-guarda-roupas.jpg',
      fallbackThumbnail: '/images/logo.png', // se a thumbnail não existir
    ...
    <div style={{ padding: "0", maxWidth: "1200px", margin: "0 auto", position: "relative" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <img src="/images/logo.png" alt="Drica & Léo" style={{ width: "35px", height: "35px", borderRadius: "50%", objectFit: "cover" }} />
          <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: "3px" }}>
            <div style={{ display: "flex", gap: "5px" }}>
              <a href="https://wa.me/5581994732981" target="_blank" rel="noopener noreferrer" style={{
                background: "#25d366", color: "white", padding: "4px 8px", borderRadius: "30px",
                textDecoration: "none", fontWeight: "600", fontSize: "0.7rem", display: "flex", alignItems: "center", gap: "3px"
              ...
              <a href="https://instagram.com/adrianamoura.organizer" target="_blank" rel="noopener noreferrer" style={{
                ...
                padding: "4px 8px", borderRadius: "30px", textDecoration: "none", fontWeight: "600", fontSize: "0.7rem",
                display: "flex", alignItems: "center", gap: "3px"
              }}><i className="fab fa-instagram"></i> Instagram</a>
            </div>
            <div style={{
              background: "linear-gradient(135deg, #4361ee, #f72585)", color: "white", padding: "2px 8px",
              borderRadius: "30px", fontSize: "0.6rem", fontWeight: "bold", display: "flex", alignItems: "center", gap: "3px",
              whiteSpace: "nowrap", border: "1px solid white"
            }}><span style={{ fontSize: "0.7rem" }}>🏆</span> Profissional Certificado</div>
          </div>
        </div>
      </div>
